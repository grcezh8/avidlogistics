-- Create only the missing Chain of Custody tables
-- This script creates the tables that were missing from the failed migration
...
PRINT 'Chain of Custody tables created successfully!';
